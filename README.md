...
This SDK exposes the API as a small set of **semantic entities** — ConversionDetail, ConversionDetailMerchant, ConversionGeneral, ConversionStatus, Deeplink, DeeplinkMerchant, Dnt, Market, Merchant, Offer, ReportDetail, ReportGeneral, ReportModified and ReportStatus — that you
