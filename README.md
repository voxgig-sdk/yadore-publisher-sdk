...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/yadore-publisher` | `npm install @voxgig-sdk/yadore-publisher` |
| Python | `voxgig-sdk-yadore-publisher` | `pip install voxgig-sdk-yadore-publisher` |
| PHP | `voxgig-sdk/yadore-publisher` | `composer require voxgig-sdk/yadore-publisher` |
| Golang | `github.com/voxgig-sdk/yadore-publisher-sdk/go` | `go get github.com/voxgig-sdk/yadore-publisher-sdk/go` |
| Ruby | `voxgig-sdk-yadore-publisher` | `gem install voxgig-sdk-yadore-publisher` |
| Lua | `voxgig-sdk-yadore-publisher` | `luarocks install voxgig-sdk-yadore-publisher` |
