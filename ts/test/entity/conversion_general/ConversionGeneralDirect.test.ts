...
describe('ConversionGeneralDirect', async () => {
  ...
  test('direct-load-conversion_general', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-conversion_general', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['YADORE_PUBLISHER_TEST_CONVERSION_GENERAL_ENTID']
