...
describe('DntDirect', async () => {
  ...
  test('direct-load-dnt', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-dnt', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['YADORE_PUBLISHER_TEST_DNT_ENTID']
