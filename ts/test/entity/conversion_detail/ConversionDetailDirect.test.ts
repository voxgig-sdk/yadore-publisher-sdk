...
describe('ConversionDetailDirect', async () => {
  ...
  test('direct-list-conversion_detail', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-conversion_detail', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['YADORE_PUBLISHER_TEST_CONVERSION_DETAIL_ENTID']
