...
describe('DeeplinkMerchantDirect', async () => {
  ...
  test('direct-list-deeplink_merchant', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-deeplink_merchant', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['YADORE_PUBLISHER_TEST_DEEPLINK_MERCHANT_ENTID']
