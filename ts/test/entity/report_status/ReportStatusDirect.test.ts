...
describe('ReportStatusDirect', async () => {
  ...
  test('direct-load-report_status', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-report_status', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['YADOREPUBLISHER_TEST_REPORT_STATUS_ENTID']
