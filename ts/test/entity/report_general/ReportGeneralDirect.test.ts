...
describe('ReportGeneralDirect', async () => {
  ...
  test('direct-load-report_general', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-report_general', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['YADORE_PUBLISHER_TEST_REPORT_GENERAL_ENTID']
