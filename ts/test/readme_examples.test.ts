...
//     (\`new YadorePublisherSDK(...)\` / \`YadorePublisherSDK.test(...)\` become
//     \`YadorePublisherSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'YadorePublisherSDK'
...
const TEST_SEED = {"entity":{"conversion_detail":{"test01":{"id":"test01"}},"conversion_detail_merchant":{"test01":{"id":"test01"}},"conversion_general":{"test01":{"id":"test01"}},"conversion_status":{"test01":{"id":"test01"}},"deeplink":{"test01":{"id":"test01"}},"deeplink_merchant":{"test01":{"id":"test01"}},"dnt":{"test01":{"id":"test01"}},"market":{"test01":{"id":"test01"}},"merchant":{"test01":{"id":"test01"}},"offer":{"test01":{"id":"test01"}},"report_detail":{"test01":{"id":"test01"}},"report_general":{"test01":{"id":"test01"}},"report_modified":{"test01":{"id":"test01"}},"report_status":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new YadorePublisherSDK(...)\` and any
// \`YadorePublisherSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+YadorePublisherSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/YadorePublisherSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
