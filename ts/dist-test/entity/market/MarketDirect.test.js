...
(0, node_test_1.describe)('MarketDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-market', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-market', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['YADORE_PUBLISHER_TEST_MARKET_ENTID'];
...
//# sourceMappingURL=MarketDirect.test.js.map