...
(0, node_test_1.describe)('ConversionGeneralDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-conversion_general', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-conversion_general', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['YADORE_PUBLISHER_TEST_CONVERSION_GENERAL_ENTID'];
...
//# sourceMappingURL=ConversionGeneralDirect.test.js.map