...
(0, node_test_1.describe)('ReportModifiedEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'report_modified.' + op, live))
                return;
        }
        ...
        let report_modified_ref01_data = Object.values(setup.data.existing.report_modified)[0];
        // LOAD
        const report_modified_ref01_ent = client.ReportModified();
        const report_modified_ref01_match_dt0 = {};
        const report_modified_ref01_data_dt0 = (await report_modified_ref01_ent.load(report_modified_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != report_modified_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/report_modified/ReportModifiedTestData.json');
    ...
    let idmap = transform(['report_modified01', 'report_modified02', 'report_modified03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['YADORE_PUBLISHER_TEST_REPORT_MODIFIED_ENTID'];
...
//# sourceMappingURL=ReportModifiedEntity.test.js.map