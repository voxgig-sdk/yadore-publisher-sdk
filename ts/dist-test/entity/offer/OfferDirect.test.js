...
(0, node_test_1.describe)('OfferDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-offer', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-offer', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-offer', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-offer', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['YADORE_PUBLISHER_TEST_OFFER_ENTID'];
...
//# sourceMappingURL=OfferDirect.test.js.map