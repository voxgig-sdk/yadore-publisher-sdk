...
(0, node_test_1.describe)('DntDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-dnt', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-dnt', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['YADORE_PUBLISHER_TEST_DNT_ENTID'];
...
//# sourceMappingURL=DntDirect.test.js.map