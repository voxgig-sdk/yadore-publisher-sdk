...
(0, node_test_1.describe)('ConversionDetailDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-conversion_detail', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-conversion_detail', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['YADORE_PUBLISHER_TEST_CONVERSION_DETAIL_ENTID'];
...
//# sourceMappingURL=ConversionDetailDirect.test.js.map