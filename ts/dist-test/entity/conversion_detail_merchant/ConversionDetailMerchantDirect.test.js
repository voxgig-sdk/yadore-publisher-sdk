...
(0, node_test_1.describe)('ConversionDetailMerchantDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.YadorePublisherSDK({
    ...
    (0, node_test_1.test)('direct-list-conversion_detail_merchant', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-conversion_detail_merchant', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.YadorePublisherSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.YADORE_PUBLISHER_APIKEY,
        }));
        let idmap = env['YADORE_PUBLISHER_TEST_CONVERSION_DETAIL_MERCHANT_ENTID'];
    ...
    const client = new __1.YadorePublisherSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ConversionDetailMerchantDirect.test.js.map