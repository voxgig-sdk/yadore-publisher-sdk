...
function envOverride(m) {
    if ('TRUE' === process.env.YADORE_PUBLISHER_TEST_LIVE ||
        'TRUE' === process.env.YADORE_PUBLISHER_TEST_OVERRIDE) {
    ...
    m.YADORE_PUBLISHER_TEST_EXPLAIN = process.env.YADORE_PUBLISHER_TEST_EXPLAIN || m.YADORE_PUBLISHER_TEST_EXPLAIN;
    return m;
}
