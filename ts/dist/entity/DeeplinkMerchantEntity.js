...
class DeeplinkMerchantEntity extends YadorePublisherEntityBase_1.YadorePublisherEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'deeplink_merchant';
        this.name_ = 'deeplink_merchant';
        this.Name = 'DeeplinkMerchant';
    }
    make() {
        return new DeeplinkMerchantEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<DeeplinkMerchant[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.DeeplinkMerchantEntity = DeeplinkMerchantEntity;
//# sourceMappingURL=DeeplinkMerchantEntity.js.map