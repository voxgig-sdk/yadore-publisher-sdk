...
exports.ReportGeneralEntity = void 0;
const YadorePublisherEntityBase_1 = require("../YadorePublisherEntityBase");
// TODO: needs Entity superclass
class ReportGeneralEntity extends YadorePublisherEntityBase_1.YadorePublisherEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'report_general';
        this.name_ = 'report_general';
        this.Name = 'ReportGeneral';
    }
    make() {
        return new ReportGeneralEntity(this._client, this.entopts());
    }
...
exports.ReportGeneralEntity = ReportGeneralEntity;
//# sourceMappingURL=ReportGeneralEntity.js.map