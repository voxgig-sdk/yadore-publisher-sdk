...
|---|---|---|
| `ts/` | @voxgig-sdk/yadore-publisher-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/yadore-publisher-sdk \
      --repository voxgig-sdk/yadore-publisher-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/yadore-publisher-sdk` shows it, and
`npm trust revoke @voxgig-sdk/yadore-publisher-sdk --id=<id>` removes it.
