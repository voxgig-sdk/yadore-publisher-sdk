...
from projectname_sdk.core.control import YadorePublisherControl
...
class YadorePublisherContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = YadorePublisherControl()
        ...
        if isinstance(sp, YadorePublisherSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, YadorePublisherResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, YadorePublisherResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return YadorePublisherOperation({})
    ...
    def make_error(self, code, msg):
        return YadorePublisherError(code, msg, self)
