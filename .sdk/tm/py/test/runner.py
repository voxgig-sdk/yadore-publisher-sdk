...
class YadorePublisherTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YadorePublisherTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = YadorePublisherTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = YadorePublisherTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
