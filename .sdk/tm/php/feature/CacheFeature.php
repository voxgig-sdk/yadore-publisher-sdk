...
// YadorePublisher SDK cache feature
...
class YadorePublisherCacheFeature extends YadorePublisherBaseFeature
{
    ...
    private function _through(YadorePublisherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
