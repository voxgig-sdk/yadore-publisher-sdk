...
// YadorePublisher SDK ratelimit feature
...
class YadorePublisherRatelimitFeature extends YadorePublisherBaseFeature
{
    ...
    private function _acquire(YadorePublisherContext $ctx): void
    {
    ...
    private function _track(YadorePublisherContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
