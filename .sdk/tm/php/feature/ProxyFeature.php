...
// YadorePublisher SDK proxy feature
...
class YadorePublisherProxyFeature extends YadorePublisherBaseFeature
{
    ...
    public function init(YadorePublisherContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (YadorePublisherContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
