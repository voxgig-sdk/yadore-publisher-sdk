...
// YadorePublisher SDK utility: fetcher

class YadorePublisherFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; YadorePublisherSDK/1.0)';
    ...
    public static function call(YadorePublisherContext $ctx, string $fullurl, array $fetchdef): array
    {
