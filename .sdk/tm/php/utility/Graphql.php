...
// YadorePublisher SDK utility: graphql
//
...
class YadorePublisherGraphql
{
    ...
    // equivalent.
    public static function body(YadorePublisherContext $ctx): mixed
    {
    ...
    public static function errors(YadorePublisherContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
