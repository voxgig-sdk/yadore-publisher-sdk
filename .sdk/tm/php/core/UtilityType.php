...
// YadorePublisher SDK utility type

class YadorePublisherUtility
{
    ...
    public static function copy(YadorePublisherUtility $src): YadorePublisherUtility
    {
        $u = new YadorePublisherUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
