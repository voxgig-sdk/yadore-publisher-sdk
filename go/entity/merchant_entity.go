...
func NewMerchantEntity(client *core.YadorePublisherSDK, entopts map[string]any) *MerchantEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MerchantEntity) GetName() string { return e.name }
...
func (e *MerchantEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MerchantEntity) Deleted() bool {
	return e.deleted
}


func (e *MerchantEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMerchantEntity(e.client, opts)
}

func (e *MerchantEntity) Data(args ...any) any {
...
func (e *MerchantEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Merchant; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MerchantEntity) DataTyped(data ...Merchant) Merchant {
	if len(data) > 0 {
		return typedFrom[Merchant](e.Data(asMap(data[0])))
	}
	return typedFrom[Merchant](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Merchant (all fields
// optional at the wire level).
func (e *MerchantEntity) MatchTyped(match ...Merchant) Merchant {
	if len(match) > 0 {
		return typedFrom[Merchant](e.Match(asMap(match[0])))
	}
	return typedFrom[Merchant](e.Match())
}
...
func (e *MerchantEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MerchantEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *MerchantEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MerchantListMatch and returns []Merchant. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MerchantEntity) ListTyped(reqmatch MerchantListMatch, ctrl map[string]any) ([]Merchant, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Merchant](res), nil
}



func (e *MerchantEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MerchantEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MerchantEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MerchantEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
