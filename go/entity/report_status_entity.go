...
func NewReportStatusEntity(client *core.YadorePublisherSDK, entopts map[string]any) *ReportStatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReportStatusEntity) GetName() string { return e.name }
...
func (e *ReportStatusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReportStatusEntity) Deleted() bool {
	return e.deleted
}


func (e *ReportStatusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReportStatusEntity(e.client, opts)
}

func (e *ReportStatusEntity) Data(args ...any) any {
...
func (e *ReportStatusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ReportStatus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReportStatusEntity) DataTyped(data ...ReportStatus) ReportStatus {
	if len(data) > 0 {
		return typedFrom[ReportStatus](e.Data(asMap(data[0])))
	}
	return typedFrom[ReportStatus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ReportStatus (all fields
// optional at the wire level).
func (e *ReportStatusEntity) MatchTyped(match ...ReportStatus) ReportStatus {
	if len(match) > 0 {
		return typedFrom[ReportStatus](e.Match(asMap(match[0])))
	}
	return typedFrom[ReportStatus](e.Match())
}
...
func (e *ReportStatusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReportStatusEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReportStatusLoadMatch and returns an ReportStatus. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReportStatusEntity) LoadTyped(reqmatch ReportStatusLoadMatch, ctrl map[string]any) (ReportStatus, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ReportStatus{}, err
	}
	return typedFrom[ReportStatus](res), nil
}



func (e *ReportStatusEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReportStatusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReportStatusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReportStatusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReportStatusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
