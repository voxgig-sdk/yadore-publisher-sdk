...
func NewOfferEntity(client *core.YadorePublisherSDK, entopts map[string]any) *OfferEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OfferEntity) GetName() string { return e.name }
...
func (e *OfferEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OfferEntity) Deleted() bool {
	return e.deleted
}


func (e *OfferEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOfferEntity(e.client, opts)
}

func (e *OfferEntity) Data(args ...any) any {
...
func (e *OfferEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Offer; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OfferEntity) DataTyped(data ...Offer) Offer {
	if len(data) > 0 {
		return typedFrom[Offer](e.Data(asMap(data[0])))
	}
	return typedFrom[Offer](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Offer (all fields
// optional at the wire level).
func (e *OfferEntity) MatchTyped(match ...Offer) Offer {
	if len(match) > 0 {
		return typedFrom[Offer](e.Match(asMap(match[0])))
	}
	return typedFrom[Offer](e.Match())
}
...
func (e *OfferEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OfferEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OfferLoadMatch and returns an Offer. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OfferEntity) LoadTyped(reqmatch OfferLoadMatch, ctrl map[string]any) (Offer, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Offer{}, err
	}
	return typedFrom[Offer](res), nil
}




func (e *OfferEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// OfferListMatch and returns []Offer. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *OfferEntity) ListTyped(reqmatch OfferListMatch, ctrl map[string]any) ([]Offer, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Offer](res), nil
}



func (e *OfferEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OfferEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OfferEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OfferEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
