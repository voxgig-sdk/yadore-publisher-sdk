...
type ConversionDetailEntity struct {
	name    string
...
func NewConversionDetailEntity(client *core.YadorePublisherSDK, entopts map[string]any) *ConversionDetailEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ConversionDetailEntity) GetName() string { return e.name }
...
func (e *ConversionDetailEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ConversionDetailEntity) Deleted() bool {
	return e.deleted
}


func (e *ConversionDetailEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewConversionDetailEntity(e.client, opts)
}

func (e *ConversionDetailEntity) Data(args ...any) any {
...
func (e *ConversionDetailEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ConversionDetail; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ConversionDetailEntity) DataTyped(data ...ConversionDetail) ConversionDetail {
	if len(data) > 0 {
		return typedFrom[ConversionDetail](e.Data(asMap(data[0])))
	}
	return typedFrom[ConversionDetail](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ConversionDetail (all fields
// optional at the wire level).
func (e *ConversionDetailEntity) MatchTyped(match ...ConversionDetail) ConversionDetail {
	if len(match) > 0 {
		return typedFrom[ConversionDetail](e.Match(asMap(match[0])))
	}
	return typedFrom[ConversionDetail](e.Match())
}
...
func (e *ConversionDetailEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ConversionDetailEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ConversionDetailEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ConversionDetailListMatch and returns []ConversionDetail. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ConversionDetailEntity) ListTyped(reqmatch ConversionDetailListMatch, ctrl map[string]any) ([]ConversionDetail, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ConversionDetail](res), nil
}



func (e *ConversionDetailEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ConversionDetailEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ConversionDetailEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ConversionDetailEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
