...
func NewDeeplinkEntity(client *core.YadorePublisherSDK, entopts map[string]any) *DeeplinkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeeplinkEntity) GetName() string { return e.name }
...
func (e *DeeplinkEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeeplinkEntity) Deleted() bool {
	return e.deleted
}


func (e *DeeplinkEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeeplinkEntity(e.client, opts)
}

func (e *DeeplinkEntity) Data(args ...any) any {
...
func (e *DeeplinkEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Deeplink; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeeplinkEntity) DataTyped(data ...Deeplink) Deeplink {
	if len(data) > 0 {
		return typedFrom[Deeplink](e.Data(asMap(data[0])))
	}
	return typedFrom[Deeplink](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Deeplink (all fields
// optional at the wire level).
func (e *DeeplinkEntity) MatchTyped(match ...Deeplink) Deeplink {
	if len(match) > 0 {
		return typedFrom[Deeplink](e.Match(asMap(match[0])))
	}
	return typedFrom[Deeplink](e.Match())
}
...
func (e *DeeplinkEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeeplinkEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DeeplinkEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DeeplinkEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeeplinkCreateData and returns an Deeplink. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DeeplinkEntity) CreateTyped(reqdata DeeplinkCreateData, ctrl map[string]any) (Deeplink, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Deeplink{}, err
	}
	return typedFrom[Deeplink](res), nil
}



func (e *DeeplinkEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeeplinkEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DeeplinkEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
