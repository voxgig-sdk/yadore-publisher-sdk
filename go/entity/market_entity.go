...
func NewMarketEntity(client *core.YadorePublisherSDK, entopts map[string]any) *MarketEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MarketEntity) GetName() string { return e.name }
...
func (e *MarketEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MarketEntity) Deleted() bool {
	return e.deleted
}


func (e *MarketEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMarketEntity(e.client, opts)
}

func (e *MarketEntity) Data(args ...any) any {
...
func (e *MarketEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Market; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MarketEntity) DataTyped(data ...Market) Market {
	if len(data) > 0 {
		return typedFrom[Market](e.Data(asMap(data[0])))
	}
	return typedFrom[Market](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Market (all fields
// optional at the wire level).
func (e *MarketEntity) MatchTyped(match ...Market) Market {
	if len(match) > 0 {
		return typedFrom[Market](e.Match(asMap(match[0])))
	}
	return typedFrom[Market](e.Match())
}
...
func (e *MarketEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MarketEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *MarketEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MarketListMatch and returns []Market. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MarketEntity) ListTyped(reqmatch MarketListMatch, ctrl map[string]any) ([]Market, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Market](res), nil
}



func (e *MarketEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MarketEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MarketEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MarketEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
