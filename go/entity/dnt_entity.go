...
func NewDntEntity(client *core.YadorePublisherSDK, entopts map[string]any) *DntEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DntEntity) GetName() string { return e.name }
...
func (e *DntEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DntEntity) Deleted() bool {
	return e.deleted
}


func (e *DntEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDntEntity(e.client, opts)
}

func (e *DntEntity) Data(args ...any) any {
...
func (e *DntEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Dnt; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DntEntity) DataTyped(data ...Dnt) Dnt {
	if len(data) > 0 {
		return typedFrom[Dnt](e.Data(asMap(data[0])))
	}
	return typedFrom[Dnt](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Dnt (all fields
// optional at the wire level).
func (e *DntEntity) MatchTyped(match ...Dnt) Dnt {
	if len(match) > 0 {
		return typedFrom[Dnt](e.Match(asMap(match[0])))
	}
	return typedFrom[Dnt](e.Match())
}
...
func (e *DntEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DntEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DntLoadMatch and returns an Dnt. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DntEntity) LoadTyped(reqmatch DntLoadMatch, ctrl map[string]any) (Dnt, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Dnt{}, err
	}
	return typedFrom[Dnt](res), nil
}



func (e *DntEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DntEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DntEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DntEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DntEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
