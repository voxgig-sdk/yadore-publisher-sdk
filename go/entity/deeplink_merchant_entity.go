...
type DeeplinkMerchantEntity struct {
	name    string
...
func NewDeeplinkMerchantEntity(client *core.YadorePublisherSDK, entopts map[string]any) *DeeplinkMerchantEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeeplinkMerchantEntity) GetName() string { return e.name }
...
func (e *DeeplinkMerchantEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeeplinkMerchantEntity) Deleted() bool {
	return e.deleted
}


func (e *DeeplinkMerchantEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeeplinkMerchantEntity(e.client, opts)
}

func (e *DeeplinkMerchantEntity) Data(args ...any) any {
...
func (e *DeeplinkMerchantEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DeeplinkMerchant; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeeplinkMerchantEntity) DataTyped(data ...DeeplinkMerchant) DeeplinkMerchant {
	if len(data) > 0 {
		return typedFrom[DeeplinkMerchant](e.Data(asMap(data[0])))
	}
	return typedFrom[DeeplinkMerchant](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DeeplinkMerchant (all fields
// optional at the wire level).
func (e *DeeplinkMerchantEntity) MatchTyped(match ...DeeplinkMerchant) DeeplinkMerchant {
	if len(match) > 0 {
		return typedFrom[DeeplinkMerchant](e.Match(asMap(match[0])))
	}
	return typedFrom[DeeplinkMerchant](e.Match())
}
...
func (e *DeeplinkMerchantEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeeplinkMerchantEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DeeplinkMerchantEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeeplinkMerchantListMatch and returns []DeeplinkMerchant. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DeeplinkMerchantEntity) ListTyped(reqmatch DeeplinkMerchantListMatch, ctrl map[string]any) ([]DeeplinkMerchant, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[DeeplinkMerchant](res), nil
}



func (e *DeeplinkMerchantEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeeplinkMerchantEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeeplinkMerchantEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DeeplinkMerchantEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
