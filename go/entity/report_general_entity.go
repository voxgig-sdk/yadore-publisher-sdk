...
type ReportGeneralEntity struct {
	name    string
...
func NewReportGeneralEntity(client *core.YadorePublisherSDK, entopts map[string]any) *ReportGeneralEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReportGeneralEntity) GetName() string { return e.name }
...
func (e *ReportGeneralEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReportGeneralEntity) Deleted() bool {
	return e.deleted
}


func (e *ReportGeneralEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReportGeneralEntity(e.client, opts)
}

func (e *ReportGeneralEntity) Data(args ...any) any {
...
func (e *ReportGeneralEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ReportGeneral; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReportGeneralEntity) DataTyped(data ...ReportGeneral) ReportGeneral {
	if len(data) > 0 {
		return typedFrom[ReportGeneral](e.Data(asMap(data[0])))
	}
	return typedFrom[ReportGeneral](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ReportGeneral (all fields
// optional at the wire level).
func (e *ReportGeneralEntity) MatchTyped(match ...ReportGeneral) ReportGeneral {
	if len(match) > 0 {
		return typedFrom[ReportGeneral](e.Match(asMap(match[0])))
	}
	return typedFrom[ReportGeneral](e.Match())
}
...
func (e *ReportGeneralEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReportGeneralEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReportGeneralLoadMatch and returns an ReportGeneral. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReportGeneralEntity) LoadTyped(reqmatch ReportGeneralLoadMatch, ctrl map[string]any) (ReportGeneral, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ReportGeneral{}, err
	}
	return typedFrom[ReportGeneral](res), nil
}



func (e *ReportGeneralEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReportGeneralEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReportGeneralEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReportGeneralEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReportGeneralEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
