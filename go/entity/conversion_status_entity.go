...
type ConversionStatusEntity struct {
	name    string
...
func NewConversionStatusEntity(client *core.YadorePublisherSDK, entopts map[string]any) *ConversionStatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ConversionStatusEntity) GetName() string { return e.name }
...
func (e *ConversionStatusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ConversionStatusEntity) Deleted() bool {
	return e.deleted
}


func (e *ConversionStatusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewConversionStatusEntity(e.client, opts)
}

func (e *ConversionStatusEntity) Data(args ...any) any {
...
func (e *ConversionStatusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ConversionStatus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ConversionStatusEntity) DataTyped(data ...ConversionStatus) ConversionStatus {
	if len(data) > 0 {
		return typedFrom[ConversionStatus](e.Data(asMap(data[0])))
	}
	return typedFrom[ConversionStatus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ConversionStatus (all fields
// optional at the wire level).
func (e *ConversionStatusEntity) MatchTyped(match ...ConversionStatus) ConversionStatus {
	if len(match) > 0 {
		return typedFrom[ConversionStatus](e.Match(asMap(match[0])))
	}
	return typedFrom[ConversionStatus](e.Match())
}
...
func (e *ConversionStatusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ConversionStatusEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ConversionStatusLoadMatch and returns an ConversionStatus. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ConversionStatusEntity) LoadTyped(reqmatch ConversionStatusLoadMatch, ctrl map[string]any) (ConversionStatus, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ConversionStatus{}, err
	}
	return typedFrom[ConversionStatus](res), nil
}



func (e *ConversionStatusEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ConversionStatusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ConversionStatusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ConversionStatusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ConversionStatusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
