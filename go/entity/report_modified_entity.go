...
type ReportModifiedEntity struct {
	name    string
...
func NewReportModifiedEntity(client *core.YadorePublisherSDK, entopts map[string]any) *ReportModifiedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReportModifiedEntity) GetName() string { return e.name }
...
func (e *ReportModifiedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReportModifiedEntity) Deleted() bool {
	return e.deleted
}


func (e *ReportModifiedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReportModifiedEntity(e.client, opts)
}

func (e *ReportModifiedEntity) Data(args ...any) any {
...
func (e *ReportModifiedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ReportModified; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReportModifiedEntity) DataTyped(data ...ReportModified) ReportModified {
	if len(data) > 0 {
		return typedFrom[ReportModified](e.Data(asMap(data[0])))
	}
	return typedFrom[ReportModified](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ReportModified (all fields
// optional at the wire level).
func (e *ReportModifiedEntity) MatchTyped(match ...ReportModified) ReportModified {
	if len(match) > 0 {
		return typedFrom[ReportModified](e.Match(asMap(match[0])))
	}
	return typedFrom[ReportModified](e.Match())
}
...
func (e *ReportModifiedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReportModifiedEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReportModifiedLoadMatch and returns an ReportModified. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReportModifiedEntity) LoadTyped(reqmatch ReportModifiedLoadMatch, ctrl map[string]any) (ReportModified, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ReportModified{}, err
	}
	return typedFrom[ReportModified](res), nil
}



func (e *ReportModifiedEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReportModifiedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReportModifiedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReportModifiedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReportModifiedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
