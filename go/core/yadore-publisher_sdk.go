...
type YadorePublisherSDK struct {
	Mode     string
...
func (sdk *YadorePublisherSDK) OptionsMap() map[string]any {
...
func (sdk *YadorePublisherSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *YadorePublisherSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *YadorePublisherSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YadorePublisherSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *YadorePublisherSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *YadorePublisherSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("YadorePublisherSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *YadorePublisherSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YadorePublisherSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("YadorePublisherSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *YadorePublisherSDK {
	...
	sdk := NewYadorePublisherSDK(sdkopts)
	sdk.Mode = "test"
