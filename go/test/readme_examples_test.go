...
const testSeed = `map[string]any{"entity": map[string]any{"conversion_detail": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversion_detail_merchant": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversion_general": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversion_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deeplink": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deeplink_merchant": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dnt": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "market": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "offer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "report_detail": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "report_general": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "report_modified": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "report_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
