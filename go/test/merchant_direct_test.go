...
type merchantDirectSetupResult struct {
...
func merchantDirectSetup(mockres any) *merchantDirectSetupResult {
	loadEnvLocal()
	...
	if live {
		...
		return &merchantDirectSetupResult{client: client, calls: calls, live: true, idmap: idmap}
	}
	...
	return &merchantDirectSetupResult{client: client, calls: calls, live: false, idmap: map[string]any{}}
}
