-- YadorePublisher SDK ConversionDetailMerchant entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversionDetailMerchantEntity = {}
ConversionDetailMerchantEntity.__index = ConversionDetailMerchantEntity


function ConversionDetailMerchantEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversionDetailMerchantEntity)
  self._name = "conversion_detail_merchant"
  self._client = client
...
function ConversionDetailMerchantEntity:get_name()
  return self._name
end


function ConversionDetailMerchantEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversionDetailMerchantEntity.new(self._client, opts)
end
...
function ConversionDetailMerchantEntity:mark_deleted()
  self._deleted = true
end


function ConversionDetailMerchantEntity:deleted()
  return true == self._deleted
end


function ConversionDetailMerchantEntity:data_set(args)
  if args ~= nil then
...
function ConversionDetailMerchantEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversionDetailMerchantEntity:match_set(args)
  if args ~= nil then
...
function ConversionDetailMerchantEntity:match_get()
...
function ConversionDetailMerchantEntity:stream(action, args, callopts)
...
---@param reqmatch ConversionDetailMerchantListMatch
---@param ctrl? table
---@return ConversionDetailMerchant[]
---@return string? err
function ConversionDetailMerchantEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConversionDetailMerchantEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversionDetailMerchantEntity
