...
local ReportModifiedEntity = {}
ReportModifiedEntity.__index = ReportModifiedEntity


function ReportModifiedEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ReportModifiedEntity)
  self._name = "report_modified"
  self._client = client
...
function ReportModifiedEntity:get_name()
  return self._name
end


function ReportModifiedEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ReportModifiedEntity.new(self._client, opts)
end
...
function ReportModifiedEntity:mark_deleted()
  self._deleted = true
end


function ReportModifiedEntity:deleted()
  return true == self._deleted
end


function ReportModifiedEntity:data_set(args)
  if args ~= nil then
...
function ReportModifiedEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ReportModifiedEntity:match_set(args)
  if args ~= nil then
...
function ReportModifiedEntity:match_get()
...
function ReportModifiedEntity:stream(action, args, callopts)
...
function ReportModifiedEntity:_run_op(ctx, post_done)
  local utility = self._utility
