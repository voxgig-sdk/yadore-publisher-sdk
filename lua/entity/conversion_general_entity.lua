...
local ConversionGeneralEntity = {}
ConversionGeneralEntity.__index = ConversionGeneralEntity


function ConversionGeneralEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversionGeneralEntity)
  self._name = "conversion_general"
  self._client = client
...
function ConversionGeneralEntity:get_name()
  return self._name
end


function ConversionGeneralEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversionGeneralEntity.new(self._client, opts)
end
...
function ConversionGeneralEntity:mark_deleted()
  self._deleted = true
end


function ConversionGeneralEntity:deleted()
  return true == self._deleted
end


function ConversionGeneralEntity:data_set(args)
  if args ~= nil then
...
function ConversionGeneralEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversionGeneralEntity:match_set(args)
  if args ~= nil then
...
function ConversionGeneralEntity:match_get()
...
function ConversionGeneralEntity:stream(action, args, callopts)
...
---@param reqmatch ConversionGeneralLoadMatch
---@param ctrl? table
---@return ConversionGeneral
---@return string? err
function ConversionGeneralEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ConversionGeneralEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversionGeneralEntity
