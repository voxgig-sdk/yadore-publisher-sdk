...
local ReportDetailEntity = {}
ReportDetailEntity.__index = ReportDetailEntity


function ReportDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ReportDetailEntity)
  self._name = "report_detail"
  self._client = client
...
function ReportDetailEntity:get_name()
  return self._name
end


function ReportDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ReportDetailEntity.new(self._client, opts)
end
...
function ReportDetailEntity:mark_deleted()
  self._deleted = true
end


function ReportDetailEntity:deleted()
  return true == self._deleted
end


function ReportDetailEntity:data_set(args)
  if args ~= nil then
...
function ReportDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ReportDetailEntity:match_set(args)
  if args ~= nil then
...
function ReportDetailEntity:match_get()
...
function ReportDetailEntity:stream(action, args, callopts)
...
function ReportDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
