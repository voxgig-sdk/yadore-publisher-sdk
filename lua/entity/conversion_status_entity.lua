...
local ConversionStatusEntity = {}
ConversionStatusEntity.__index = ConversionStatusEntity


function ConversionStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversionStatusEntity)
  self._name = "conversion_status"
  self._client = client
...
function ConversionStatusEntity:get_name()
  return self._name
end


function ConversionStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversionStatusEntity.new(self._client, opts)
end
...
function ConversionStatusEntity:mark_deleted()
  self._deleted = true
end


function ConversionStatusEntity:deleted()
  return true == self._deleted
end


function ConversionStatusEntity:data_set(args)
  if args ~= nil then
...
function ConversionStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversionStatusEntity:match_set(args)
  if args ~= nil then
...
function ConversionStatusEntity:match_get()
...
function ConversionStatusEntity:stream(action, args, callopts)
...
---@param reqmatch ConversionStatusLoadMatch
---@param ctrl? table
---@return ConversionStatus
---@return string? err
function ConversionStatusEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ConversionStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
