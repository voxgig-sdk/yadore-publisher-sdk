-- YadorePublisher SDK ConversionDetail entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversionDetailEntity = {}
ConversionDetailEntity.__index = ConversionDetailEntity


function ConversionDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversionDetailEntity)
  self._name = "conversion_detail"
  self._client = client
...
function ConversionDetailEntity:get_name()
  return self._name
end


function ConversionDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversionDetailEntity.new(self._client, opts)
end
...
function ConversionDetailEntity:mark_deleted()
  self._deleted = true
end


function ConversionDetailEntity:deleted()
  return true == self._deleted
end


function ConversionDetailEntity:data_set(args)
  if args ~= nil then
...
function ConversionDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversionDetailEntity:match_set(args)
  if args ~= nil then
...
function ConversionDetailEntity:match_get()
...
function ConversionDetailEntity:stream(action, args, callopts)
...
function ConversionDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
