...
describe("DeeplinkEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set YADORE_PUBLISHER_TEST_DEEPLINK_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    deeplink_ref01_data = helpers.to_map(type(deeplink_ref01_data_result) == 'table' and deeplink_ref01_data_result.data_get and deeplink_ref01_data_result:data_get() or deeplink_ref01_data_result)
...
function deeplink_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("YADORE_PUBLISHER_TEST_DEEPLINK_ENTID")
