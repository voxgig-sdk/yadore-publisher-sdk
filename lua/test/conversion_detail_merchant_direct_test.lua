-- ConversionDetailMerchant direct test
...
describe("ConversionDetailMerchantDirect", function()
  it("should direct-list-conversion_detail_merchant", function()
    local setup = conversion_detail_merchant_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-conversion_detail_merchant", setup.live and "live" or "unit")
...
function conversion_detail_merchant_direct_setup(mockres)
