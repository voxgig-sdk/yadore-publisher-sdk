...
describe("MerchantEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set YADOREPUBLISHER_TEST_MERCHANT_ENTID JSON to run live")
      return
    end
...
function merchant_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("YADOREPUBLISHER_TEST_MERCHANT_ENTID")
