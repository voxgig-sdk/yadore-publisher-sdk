...
describe("MerchantEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:Merchant(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:Merchant(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set YADORE_PUBLISHER_TEST_MERCHANT_ENTID JSON to run live")
      return
    end
...
function merchant_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("YADORE_PUBLISHER_TEST_MERCHANT_ENTID")
