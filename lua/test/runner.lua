...
function runner.env_override(m)
  local live = runner.getenv("YADORE_PUBLISHER_TEST_LIVE")
  local override = runner.getenv("YADORE_PUBLISHER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("YADORE_PUBLISHER_TEST_EXPLAIN")
