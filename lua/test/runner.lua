...
function runner.env_override(m)
  local live = runner.getenv("YADOREPUBLISHER_TEST_LIVE")
  local override = runner.getenv("YADOREPUBLISHER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("YADOREPUBLISHER_TEST_EXPLAIN")
