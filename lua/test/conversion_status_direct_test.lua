...
describe("ConversionStatusDirect", function()
  it("should direct-load-conversion_status", function()
    local setup = conversion_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-conversion_status", setup.live and "live" or "unit")
...
function conversion_status_direct_setup(mockres)
