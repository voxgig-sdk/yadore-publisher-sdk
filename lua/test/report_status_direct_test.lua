...
describe("ReportStatusDirect", function()
  it("should direct-load-report_status", function()
    local setup = report_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-report_status", setup.live and "live" or "unit")
...
function report_status_direct_setup(mockres)
