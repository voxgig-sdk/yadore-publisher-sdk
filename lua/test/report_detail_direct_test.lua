...
describe("ReportDetailDirect", function()
  it("should direct-list-report_detail", function()
    local setup = report_detail_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-report_detail", setup.live and "live" or "unit")
...
function report_detail_direct_setup(mockres)
