...
describe("DeeplinkMerchantDirect", function()
  it("should direct-list-deeplink_merchant", function()
    local setup = deeplink_merchant_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-deeplink_merchant", setup.live and "live" or "unit")
...
function deeplink_merchant_direct_setup(mockres)
