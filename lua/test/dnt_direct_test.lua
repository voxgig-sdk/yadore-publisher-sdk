...
describe("DntDirect", function()
  it("should direct-load-dnt", function()
    local setup = dnt_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dnt", setup.live and "live" or "unit")
...
function dnt_direct_setup(mockres)
