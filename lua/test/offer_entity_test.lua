...
describe("OfferEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set YADOREPUBLISHER_TEST_OFFER_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    local offer_ref01_data_dt0_load_result = helpers.to_map(offer_ref01_data_dt0_loaded)
...
function offer_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("YADOREPUBLISHER_TEST_OFFER_ENTID")
