...
describe("ReportModifiedDirect", function()
  it("should direct-load-report_modified", function()
    local setup = report_modified_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-report_modified", setup.live and "live" or "unit")
...
function report_modified_direct_setup(mockres)
