...
describe("ConversionStatusEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set YADORE_PUBLISHER_TEST_CONVERSION_STATUS_ENTID JSON to run live")
      return
    end
...
function conversion_status_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("YADORE_PUBLISHER_TEST_CONVERSION_STATUS_ENTID")
