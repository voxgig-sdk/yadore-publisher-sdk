...
describe("MarketDirect", function()
  it("should direct-list-market", function()
    local setup = market_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-market", setup.live and "live" or "unit")
