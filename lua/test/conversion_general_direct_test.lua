...
describe("ConversionGeneralDirect", function()
  it("should direct-load-conversion_general", function()
    local setup = conversion_general_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-conversion_general", setup.live and "live" or "unit")
...
function conversion_general_direct_setup(mockres)
