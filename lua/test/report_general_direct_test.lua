...
describe("ReportGeneralDirect", function()
  it("should direct-load-report_general", function()
    local setup = report_general_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-report_general", setup.live and "live" or "unit")
...
function report_general_direct_setup(mockres)
