...
from yadorepublisher_sdk.utility import register

# Load features
from yadorepublisher_sdk.feature.base_feature import YadorePublisherBaseFeature
from yadorepublisher_sdk.features import _has_feature, _make_feature
...
class YadorePublisherSDK:
    ...
    def __init__(self, options=None):
        ...
        from yadorepublisher_sdk.config import shared_config
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("YadorePublisherSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def ConversionDetail(self, data=None) -> "ConversionDetailEntity":
        ...
        from yadorepublisher_sdk.entity.conversion_detail_entity import ConversionDetailEntity
    ...
    def ConversionDetailMerchant(self, data=None) -> "ConversionDetailMerchantEntity":
        ...
        from yadorepublisher_sdk.entity.conversion_detail_merchant_entity import ConversionDetailMerchantEntity
    ...
    def ConversionGeneral(self, data=None) -> "ConversionGeneralEntity":
        ...
        from yadorepublisher_sdk.entity.conversion_general_entity import ConversionGeneralEntity
    ...
    def ConversionStatus(self, data=None) -> "ConversionStatusEntity":
        ...
        from yadorepublisher_sdk.entity.conversion_status_entity import ConversionStatusEntity
    ...
    def Deeplink(self, data=None) -> "DeeplinkEntity":
        ...
        from yadorepublisher_sdk.entity.deeplink_entity import DeeplinkEntity
    ...
    def Merchant(self, data=None) -> "MerchantEntity":
        ...
        from yadorepublisher_sdk.entity.merchant_entity import MerchantEntity
        return MerchantEntity(self, data)


    def Offer(self, data=None) -> "OfferEntity":
        """Entity factory: client.Offer().list() / client.Offer().load({"id": ...})."""
        from yadorepublisher_sdk.entity.offer_entity import OfferEntity
    ...
    def ReportDetail(self, data=None) -> "ReportDetailEntity":
        ...
        from yadorepublisher_sdk.entity.report_detail_entity import ReportDetailEntity
    ...
    def ReportGeneral(self, data=None) -> "ReportGeneralEntity":
        ...
        from yadorepublisher_sdk.entity.report_general_entity import ReportGeneralEntity
    ...
    def ReportModified(self, data=None) -> "ReportModifiedEntity":
        ...
        from yadorepublisher_sdk.entity.report_modified_entity import ReportModifiedEntity
    ...
    def ReportStatus(self, data=None) -> "ReportStatusEntity":
        ...
        from yadorepublisher_sdk.entity.report_status_entity import ReportStatusEntity
