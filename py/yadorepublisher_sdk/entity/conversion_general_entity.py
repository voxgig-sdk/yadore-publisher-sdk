...
class ConversionGeneralEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversionGeneralEntity(self._client, opts)
    ...
    def data_get(self) -> ConversionGeneral:
    ...
    def match_get(self) -> ConversionGeneral:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversionGeneral:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversionGeneral().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
