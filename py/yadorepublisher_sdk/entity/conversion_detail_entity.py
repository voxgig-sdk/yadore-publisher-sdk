...
class ConversionDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversionDetailEntity(self._client, opts)
    ...
    def data_get(self) -> ConversionDetail:
    ...
    def match_get(self) -> ConversionDetail:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConversionDetail]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConversionDetail().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
