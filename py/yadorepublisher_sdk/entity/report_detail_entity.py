...
class ReportDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReportDetailEntity(self._client, opts)
    ...
    def data_get(self) -> ReportDetail:
    ...
    def match_get(self) -> ReportDetail:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ReportDetail]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ReportDetail().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
