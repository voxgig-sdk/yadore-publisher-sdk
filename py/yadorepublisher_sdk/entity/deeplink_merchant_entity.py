...
class DeeplinkMerchantEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DeeplinkMerchantEntity(self._client, opts)
    ...
    def data_get(self) -> DeeplinkMerchant:
    ...
    def match_get(self) -> DeeplinkMerchant:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[DeeplinkMerchant]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.DeeplinkMerchant().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
