...
class DeeplinkEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DeeplinkEntity(self._client, opts)
    ...
    def create(self, reqdata: DeeplinkCreateData, ctrl=None) -> Deeplink:
        utility = self._utility
