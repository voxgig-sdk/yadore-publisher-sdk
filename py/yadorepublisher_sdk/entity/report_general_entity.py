...
class ReportGeneralEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReportGeneralEntity(self._client, opts)
    ...
    def data_get(self) -> ReportGeneral:
    ...
    def match_get(self) -> ReportGeneral:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ReportGeneral:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ReportGeneral().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
