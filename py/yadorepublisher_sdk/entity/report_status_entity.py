...
class ReportStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReportStatusEntity(self._client, opts)
    ...
    def data_get(self) -> ReportStatus:
    ...
    def match_get(self) -> ReportStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ReportStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ReportStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
