...
class ConversionStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversionStatusEntity(self._client, opts)
    ...
    def data_get(self) -> ConversionStatus:
    ...
    def match_get(self) -> ConversionStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversionStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversionStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
