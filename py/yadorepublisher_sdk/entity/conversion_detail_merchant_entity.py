...
from yadorepublisher_sdk.yadorepublisher_types import (
...
class ConversionDetailMerchantEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversionDetailMerchantEntity(self._client, opts)
    ...
    def data_get(self) -> ConversionDetailMerchant:
    ...
    def match_get(self) -> ConversionDetailMerchant:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConversionDetailMerchant]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConversionDetailMerchant().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
