    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set YADORE_PUBLISHER_TEST_REPORT_MODIFIED_ENTID JSON to run live")
        client = setup["client"]
...
def _report_modified_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "YADORE_PUBLISHER_TEST_REPORT_MODIFIED_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("YADORE_PUBLISHER_TEST_REPORT_MODIFIED_ENTID"))
