# YadorePublisher SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions YadorePublisherSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both YadorePublisherSDK(...) and YadorePublisherSDK.test(...) become
#      YadorePublisherSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "yadorepublisher_sdk"
_SDK_CLASS = "YadorePublisherSDK"
...
_ENTITIES = {
    ...
    "ConversionDetailMerchant": "conversion_detail_merchant",
    "ConversionGeneral": "conversion_general",
    "ConversionStatus": "conversion_status",
    "Deeplink": "deeplink",
    "DeeplinkMerchant": "deeplink_merchant",
    "Dnt": "dnt",
    "Market": "market",
    "Merchant": "merchant",
    "Offer": "offer",
    "ReportDetail": "report_detail",
    "ReportGeneral": "report_general",
    "ReportModified": "report_modified",
