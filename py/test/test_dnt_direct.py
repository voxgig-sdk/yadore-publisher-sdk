...
class TestDntDirect:
    ...
    def test_should_direct_load_dnt(self):
        setup = _dnt_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-dnt", "live" if setup["live"] else "unit")
        if _skip:
