    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set YADOREPUBLISHER_TEST_REPORT_GENERAL_ENTID JSON to run live")
        client = setup["client"]
...
def _report_general_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "YADOREPUBLISHER_TEST_REPORT_GENERAL_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("YADOREPUBLISHER_TEST_REPORT_GENERAL_ENTID"))
