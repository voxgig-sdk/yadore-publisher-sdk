...
func registerSDKWords(r *eng.Registry, client *sdk.YadorePublisherSDK) {
...
func runOp(client *sdk.YadorePublisherSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
