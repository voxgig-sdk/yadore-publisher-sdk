module github.com/voxgig-sdk/yadore-publisher-sdk/go-cli

go 1.24.7

require github.com/voxgig-sdk/yadore-publisher-sdk/go v0.0.0
...
replace github.com/voxgig-sdk/yadore-publisher-sdk/go => ../go
