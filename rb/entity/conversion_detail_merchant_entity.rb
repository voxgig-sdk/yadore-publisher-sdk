...
class ConversionDetailMerchantEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "conversion_detail_merchant"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ConversionDetailMerchantEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [ConversionDetailMerchantListMatch, Hash, nil] match filter (any subset of
  #   ConversionDetailMerchant fields); defaults to nil, treated as an empty match that lists all.
