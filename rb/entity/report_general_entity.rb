...
class ReportGeneralEntity
  ...
  def make
    opts = @_entopts.dup
    ReportGeneralEntity.new(@_client, opts)
  end
  ...
  # @return [ReportGeneral, Hash] the current ReportGeneral data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ReportGeneral fields)
  def match_get
  ...
  #
  # @param reqmatch [ReportGeneralLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ReportGeneral.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ReportGeneral, Hash] the loaded ReportGeneral; raises YadorePublisherError on failure
