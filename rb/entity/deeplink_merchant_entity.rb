...
class DeeplinkMerchantEntity
  ...
  def make
    opts = @_entopts.dup
    DeeplinkMerchantEntity.new(@_client, opts)
  end
  ...
  # @return [DeeplinkMerchant, Hash] the current DeeplinkMerchant data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DeeplinkMerchant fields)
  def match_get
  ...
  #
  # @param reqmatch [DeeplinkMerchantListMatch, Hash, nil] match filter (any subset of
  #   DeeplinkMerchant fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<DeeplinkMerchant>, Array] the matching DeeplinkMerchant items; raises YadorePublisherError on failure
