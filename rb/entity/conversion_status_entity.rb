...
class ConversionStatusEntity
  ...
  def make
    opts = @_entopts.dup
    ConversionStatusEntity.new(@_client, opts)
  end
  ...
  # @return [ConversionStatus, Hash] the current ConversionStatus data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ConversionStatus fields)
  def match_get
  ...
  #
  # @param reqmatch [ConversionStatusLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ConversionStatus.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ConversionStatus, Hash] the loaded ConversionStatus; raises YadorePublisherError on failure
