...
class DeeplinkEntity
  ...
  def make
    opts = @_entopts.dup
    DeeplinkEntity.new(@_client, opts)
  end
  ...
  # @return [Deeplink, Hash] the current Deeplink data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Deeplink fields)
  def match_get
  ...
  #
  # @param reqdata [DeeplinkCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Deeplink, Hash] the created Deeplink; raises YadorePublisherError on failure
