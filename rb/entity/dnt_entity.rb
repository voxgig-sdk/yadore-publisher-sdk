...
class DntEntity
  ...
  # @return [Dnt, Hash] the current Dnt data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Dnt fields)
  def match_get
  ...
  # Load a single Dnt.
  #
  # @param reqmatch [DntLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Dnt.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Dnt, Hash] the loaded Dnt; raises YadorePublisherError on failure
