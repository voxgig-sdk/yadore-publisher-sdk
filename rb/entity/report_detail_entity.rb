...
class ReportDetailEntity
  ...
  def make
    opts = @_entopts.dup
    ReportDetailEntity.new(@_client, opts)
  end
  ...
  # @return [ReportDetail, Hash] the current ReportDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ReportDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [ReportDetailListMatch, Hash, nil] match filter (any subset of
  #   ReportDetail fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ReportDetail>, Array] the matching ReportDetail items; raises YadorePublisherError on failure
