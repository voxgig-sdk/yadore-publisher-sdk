...
class MarketEntity
  ...
  #
  # @param reqmatch [MarketListMatch, Hash, nil] match filter (any subset of
  #   Market fields); defaults to nil, treated as an empty match that lists all.
