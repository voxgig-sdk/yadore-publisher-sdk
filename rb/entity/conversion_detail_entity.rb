...
class ConversionDetailEntity
  ...
  def make
    opts = @_entopts.dup
    ConversionDetailEntity.new(@_client, opts)
  end
  ...
  # @return [ConversionDetail, Hash] the current ConversionDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ConversionDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [ConversionDetailListMatch, Hash, nil] match filter (any subset of
  #   ConversionDetail fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ConversionDetail>, Array] the matching ConversionDetail items; raises YadorePublisherError on failure
