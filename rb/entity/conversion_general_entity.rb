...
class ConversionGeneralEntity
  ...
  def make
    opts = @_entopts.dup
    ConversionGeneralEntity.new(@_client, opts)
  end
  ...
  # @return [ConversionGeneral, Hash] the current ConversionGeneral data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ConversionGeneral fields)
  def match_get
  ...
  #
  # @param reqmatch [ConversionGeneralLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ConversionGeneral.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ConversionGeneral, Hash] the loaded ConversionGeneral; raises YadorePublisherError on failure
