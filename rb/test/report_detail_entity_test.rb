...
class ReportDetailEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set YADOREPUBLISHER_TEST_REPORT_DETAIL_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def report_detail_basic_setup(extra)
  ...
  entid_env_raw = ENV["YADOREPUBLISHER_TEST_REPORT_DETAIL_ENTID"]
