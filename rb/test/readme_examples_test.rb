...
#      offline in seeded test mode (YadorePublisherSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "YadorePublisher_sdk.rb")
  SDK_CLASS = "YadorePublisherSDK"
