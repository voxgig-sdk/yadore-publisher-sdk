# YadorePublisher SDK — Agent Guide
...
**Entities** (14): `ConversionDetail`, `ConversionDetailMerchant`, `ConversionGeneral`, `ConversionStatus`, `Deeplink`, `DeeplinkMerchant`, `Dnt`, `Market`, `Merchant`, `Offer`, `ReportDetail`, `ReportGeneral`, `ReportModified`, `ReportStatus`.
