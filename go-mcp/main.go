// Command YadorePublisher-mcp is an MCP server exposing the YadorePublisher
// SDK as MCP tools.
//
// Two tools are registered:
//
//	YadorePublisher_list  — list records of an entity
//	YadorePublisher_load  — load a single record of an entity
//
