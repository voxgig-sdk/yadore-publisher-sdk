...
// YadorePublisher SDK audit feature
...
class YadorePublisherAuditFeature extends YadorePublisherBaseFeature
{
    ...
    private function _emit(YadorePublisherContext $ctx, string $outcome): void
    {
