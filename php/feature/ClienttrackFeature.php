...
// YadorePublisher SDK clienttrack feature
...
class YadorePublisherClienttrackFeature extends YadorePublisherBaseFeature
{
    ...
    public function PostConstruct(YadorePublisherContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'YadorePublisher-SDK';
