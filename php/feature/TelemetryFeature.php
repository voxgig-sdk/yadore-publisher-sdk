...
// YadorePublisher SDK telemetry feature
...
class YadorePublisherTelemetryFeature extends YadorePublisherBaseFeature
{
    ...
    private function _close(YadorePublisherContext $ctx, bool $ok): void
    {
