...
// YadorePublisher SDK rbac feature
...
class YadorePublisherRbacFeature extends YadorePublisherBaseFeature
{
    ...
    private function _required(YadorePublisherContext $ctx): ?string
    {
    ...
    private function _reject(YadorePublisherContext $ctx, string $required): void
    {
    ...
    private function _track(YadorePublisherContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
