...
// YadorePublisher SDK metrics feature
...
class YadorePublisherMetricsFeature extends YadorePublisherBaseFeature
{
    ...
    private function _record(YadorePublisherContext $ctx, bool $ok): void
    {
