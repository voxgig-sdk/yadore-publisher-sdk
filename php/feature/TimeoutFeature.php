...
// YadorePublisher SDK timeout feature
...
class YadorePublisherTimeoutFeature extends YadorePublisherBaseFeature
{
    ...
    private function _with_timeout(YadorePublisherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(YadorePublisherContext $_ctx, float $ms): void
    {
        $client = $this->client;
