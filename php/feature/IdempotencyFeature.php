...
// YadorePublisher SDK idempotency feature
...
class YadorePublisherIdempotencyFeature extends YadorePublisherBaseFeature
{
    ...
    private function _mutating(YadorePublisherContext $ctx): bool
    {
