...
// YadorePublisher SDK streaming feature
...
class YadorePublisherStreamingFeature extends YadorePublisherBaseFeature
{
    ...
    private function _iterate(YadorePublisherResult $result): \Generator
    {
    ...
    private function _streamable(YadorePublisherContext $ctx): bool
    {
