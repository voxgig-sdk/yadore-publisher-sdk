...
// YadorePublisher SDK netsim feature
...
class YadorePublisherNetsimFeature extends YadorePublisherBaseFeature
{
    ...
    private function _simulate(YadorePublisherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(YadorePublisherContext $ctx, array $applied): void
    {
        $client = $this->client;
