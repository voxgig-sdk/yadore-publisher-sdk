...
// YadorePublisher SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class YadorePublisherMakeRequest
{
    public static function call(YadorePublisherContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new YadorePublisherResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new YadorePublisherResponse($fetched);
        } else {
