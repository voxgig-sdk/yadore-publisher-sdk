...
// YadorePublisher SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (YadorePublisherSDK::test)
...
{
    private const SDK_CLASS = 'YadorePublisherSDK';
    ...
    private const SDK_BASE = 'yadorepublisher_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../yadorepublisher_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
