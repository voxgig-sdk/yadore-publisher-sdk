...
class ConversionDetailDirectTest extends TestCase
{
    public function test_direct_list_conversion_detail(): void
    {
        $setup = conversion_detail_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-conversion_detail", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
