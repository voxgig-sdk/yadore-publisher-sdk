...
// YadorePublisher SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = YadorePublisherOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(YadorePublisherOmni::structfix($now, Struct::undef()))
                        !== json_encode(YadorePublisherOmni::structfix($val, Struct::undef()))) {
