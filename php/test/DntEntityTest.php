...
class DntEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set YADORE_PUBLISHER_TEST_DNT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function dnt_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("YADORE_PUBLISHER_TEST_DNT_ENTID");
