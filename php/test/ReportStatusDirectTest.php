...
class ReportStatusDirectTest extends TestCase
{
    public function test_direct_load_report_status(): void
    {
        $setup = report_status_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-report_status", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
