...
class ConversionGeneralDirectTest extends TestCase
{
    public function test_direct_load_conversion_general(): void
    {
        $setup = conversion_general_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-conversion_general", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
