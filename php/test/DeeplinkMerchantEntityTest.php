...
class DeeplinkMerchantEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set YADOREPUBLISHER_TEST_DEEPLINK_MERCHANT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function deeplink_merchant_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("YADOREPUBLISHER_TEST_DEEPLINK_MERCHANT_ENTID");
