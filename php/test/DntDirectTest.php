...
class DntDirectTest extends TestCase
{
    public function test_direct_load_dnt(): void
    {
        $setup = dnt_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-dnt", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
