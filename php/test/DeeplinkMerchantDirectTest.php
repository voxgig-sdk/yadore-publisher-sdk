...
class DeeplinkMerchantDirectTest extends TestCase
{
    public function test_direct_list_deeplink_merchant(): void
    {
        $setup = deeplink_merchant_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-deeplink_merchant", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
