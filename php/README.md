...
The PHP SDK for the YadorePublisher API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->ConversionDetail(null)->list(null, null);
...
[$result, $err] = $client->YadorePublisher(null)->load(
    ["id" => "test01"], null
);
