...
// YadorePublisher SDK Deeplink entity
...
class DeeplinkEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeeplinkEntity($this->_client, $opts);
    }

    /**
     * @param Deeplink|array $args Deeplink data (assoc-array) to store.
     */
    ...
    /**
     * @return Deeplink|array The current Deeplink data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Deeplink fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Deeplink fields).
     */
     ...
     *
     * @param DeeplinkCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeeplinkCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Deeplink|array The created Deeplink as an assoc-array at the
