...
// YadorePublisher SDK Market entity
...
class MarketEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MarketEntity($this->_client, $opts);
    }

    /**
     * @param Market|array $args Market data (assoc-array) to store.
     */
    ...
    /**
     * @return Market|array The current Market data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Market fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Market fields).
     */
     ...
     *
     * @param MarketListMatch|array|null $reqmatch Match filter (any subset
     *   of Market fields) as an assoc-array; MarketListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Market[]|array A list of Market items as assoc-arrays at
