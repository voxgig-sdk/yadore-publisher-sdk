...
// YadorePublisher SDK ReportGeneral entity
...
class ReportGeneralEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReportGeneralEntity($this->_client, $opts);
    }

    /**
     * @param ReportGeneral|array $args ReportGeneral data (assoc-array) to store.
     */
    ...
    /**
     * @return ReportGeneral|array The current ReportGeneral data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReportGeneral fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReportGeneral fields).
     */
    ...
    /**
     * Load a single ReportGeneral.
     *
     * @param ReportGeneralLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ReportGeneralLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReportGeneral|array The loaded ReportGeneral as an assoc-array at the
