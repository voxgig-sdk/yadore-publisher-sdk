...
// YadorePublisher SDK Merchant entity
...
class MerchantEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MerchantEntity($this->_client, $opts);
    }

    /**
     * @param Merchant|array $args Merchant data (assoc-array) to store.
     */
    ...
    /**
     * @return Merchant|array The current Merchant data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Merchant fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Merchant fields).
     */
    ...
    /**
     * List Merchant items matching the given filter.
     *
     * @param MerchantListMatch|array|null $reqmatch Match filter (any subset
     *   of Merchant fields) as an assoc-array; MerchantListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Merchant[]|array A list of Merchant items as assoc-arrays at
