...
// YadorePublisher SDK Offer entity
...
class OfferEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OfferEntity($this->_client, $opts);
    }

    /**
     * @param Offer|array $args Offer data (assoc-array) to store.
     */
    ...
    /**
     * @return Offer|array The current Offer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Offer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Offer fields).
     */
     ...
     * Load a single Offer.
     *
     * @param OfferLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OfferLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Offer|array The loaded Offer as an assoc-array at the
    ...
    /**
     * List Offer items matching the given filter.
     *
     * @param OfferListMatch|array|null $reqmatch Match filter (any subset
     *   of Offer fields) as an assoc-array; OfferListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Offer[]|array A list of Offer items as assoc-arrays at
