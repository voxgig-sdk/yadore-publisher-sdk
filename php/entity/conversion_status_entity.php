...
// YadorePublisher SDK ConversionStatus entity
...
class ConversionStatusEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ConversionStatusEntity($this->_client, $opts);
    }

    /**
     * @param ConversionStatus|array $args ConversionStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversionStatus|array The current ConversionStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversionStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversionStatus fields).
     */
    ...
    /**
     * Load a single ConversionStatus.
     *
     * @param ConversionStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversionStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversionStatus|array The loaded ConversionStatus as an assoc-array at the
