...
// YadorePublisher SDK ReportModified entity
...
class ReportModifiedEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReportModifiedEntity($this->_client, $opts);
    }

    /**
     * @param ReportModified|array $args ReportModified data (assoc-array) to store.
     */
    ...
    /**
     * @return ReportModified|array The current ReportModified data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReportModified fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReportModified fields).
     */
    ...
    /**
     * Load a single ReportModified.
     *
     * @param ReportModifiedLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ReportModifiedLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReportModified|array The loaded ReportModified as an assoc-array at the
