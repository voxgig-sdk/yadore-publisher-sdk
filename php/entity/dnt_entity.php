...
// YadorePublisher SDK Dnt entity
...
class DntEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DntEntity($this->_client, $opts);
    }

    /**
     * @param Dnt|array $args Dnt data (assoc-array) to store.
     */
    ...
    /**
     * @return Dnt|array The current Dnt data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Dnt fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Dnt fields).
     */
     ...
     * Load a single Dnt.
     *
     * @param DntLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DntLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dnt|array The loaded Dnt as an assoc-array at the
