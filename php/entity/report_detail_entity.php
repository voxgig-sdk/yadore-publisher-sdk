...
// YadorePublisher SDK ReportDetail entity
...
class ReportDetailEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReportDetailEntity($this->_client, $opts);
    }

    /**
     * @param ReportDetail|array $args ReportDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return ReportDetail|array The current ReportDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReportDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReportDetail fields).
     */
    ...
    /**
     * List ReportDetail items matching the given filter.
     *
     * @param ReportDetailListMatch|array|null $reqmatch Match filter (any subset
     *   of ReportDetail fields) as an assoc-array; ReportDetailListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReportDetail[]|array A list of ReportDetail items as assoc-arrays at
